...
public class MyMovieRecyclerViewAdapter extends RecyclerView.Adapter<MyMovieRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setText(mValues.get(position).getName());  //adı
        holder.mView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(mListener != null){
                    mListener.movieSelected(holder.mItem);
                    notifyItemChanged(selectedIndex);                //hangi satırda?
                    selectedIndex = holder.getLayoutPosition();
                    notifyItemChanged(selectedIndex);                  //şuan hangi satırda
                }
            }
        });
        holder.itemView.setBackgroundColor(selectedIndex == position?  //seçili indexin rengini değiş.
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public final View mView;      //movieyi tutan her row bir view. row represent movie name and id.
